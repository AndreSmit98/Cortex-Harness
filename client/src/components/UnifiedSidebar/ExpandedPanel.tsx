    ...
    <TooltipAnchor
      ...
      render={
        <a
          ...
          className="cortex-new-chat-control flex h-9 w-9 items-center justify-center rounded-lg transition-colors hover:bg-surface-hover"
          onClick={handleClick}
        >
    ...
    <TooltipAnchor
      ...
      render={
        <Button
          ...
          className={cn(
            'cortex-nav-control h-9 w-9 rounded-lg',
...
function ExpandedPanel({
  ...
  return (
    <div className="cortex-sidebar-rail flex h-full flex-shrink-0 flex-col gap-2 border-r border-border-light bg-transparent px-2 py-2">
      <TooltipAnchor
        side="right"
